...
RUN $JAVA_HOME/bin/keytool -importkeystore -deststorepass changeit -destkeypass changeit -destkeystore $JAVA_HOME/lib/security/cacerts -srckeystore /etc/ssl/key.p12 -srcstoretype PKCS12 -srcstorepass qwertyu
